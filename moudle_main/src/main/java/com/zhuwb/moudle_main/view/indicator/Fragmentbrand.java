...
public class Fragmentbrand extends LazyFragment implements MessageContract.IFragmentView {
    ...
    RecyclerView mainMoldBrandRefreshlistview;
    Unbinder unbinder;
    ...
    private void init() {
        ...
        //设置recycleView
        mainMoldBrandRefreshlistview.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        adapter.setOnLoadMoreListener(new BaseQuickAdapter.RequestLoadMoreListener() {
            ...
            public void onLoadMoreRequested() {
                ...
                mainMoldBrandRefreshlistview.postDelayed(new Runnable() {
                    @Override
                    public void run() {
