...
public class Fragment_recruitment extends LazyFragment implements RefreshListView.OnLoadMoreListener, RefreshListView.OnRefreshListener {
    ...
    private void init() {
        ...
        iListMessage.getMessage(getActivity(), mainMoldRecruitmentRefreshlistview, mold);
    }
