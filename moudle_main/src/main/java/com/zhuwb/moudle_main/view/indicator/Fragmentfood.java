...
public class Fragmentfood extends LazyFragment implements MessageContract.IFragmentView {
    private Banner mainbanner;
    @BindView(R2.id.main_mold_food_refreshlistview)
    RecyclerView mainMoldFoodRefreshlistview;
    Unbinder unbinder;
    ...
    private void init() {
        ...
        //设置recycleView
        mainMoldFoodRefreshlistview.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new MyRVAdapter(R.layout.main_message_item, messageBeanList, manager);
        adapter.addHeaderView(view1);
        mainMoldFoodRefreshlistview.setAdapter(adapter);
        ...
        adapter.setOnLoadMoreListener(new BaseQuickAdapter.RequestLoadMoreListener() {
            ...
            public void onLoadMoreRequested() {
                ...
                mainMoldFoodRefreshlistview.postDelayed(new Runnable() {
                    @Override
                    public void run() {
